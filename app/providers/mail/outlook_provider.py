"""Outlook mail provider (Microsoft Graph API)."""
...
from .base import _extract_otp, _is_openai_sender, _parse_dt
...
# Raise terminal error để job kết thúc nhanh thay vị chờ OTP timeout (180s).
