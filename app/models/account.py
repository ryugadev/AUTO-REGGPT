"""Account models for signup hybrid."""
...
class SignupRequest(BaseModel):
    ...
    mail_provider: str = Field(
        default="worker",
        description="Provider: 'worker', 'outlook', 'gmail_advanced', hoặc 'auto_gmail_otp'.",
        pattern="^(worker|outlook|gmail_advanced|auto_gmail_otp)$",
    )
