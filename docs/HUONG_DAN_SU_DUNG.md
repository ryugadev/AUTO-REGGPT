...
#### Truy cập Web UI:
Mở trình duyệt và vào: **[http://127.0.0.1:8089/](http://127.0.0.1:8089/)**
...
### CLI Options:
- **Headless mode (ẩn browser):** `--headless`
- **Sử dụng proxy:** `--proxy http://proxy.example.com:8080`
- **Timeout OTP:** `--otp-timeout 180`
- **Bật HAR capture (debug):** `--har`
- **Custom output path:** `--output runtime/sessions/custom.json`
...
- **Concurrency:** Tối đa 3 jobs song song (Web UI)
- **Memory:** ~200MB/job
...
- **Web UI:** [http://127.0.0.1:8089/](http://127.0.0.1:8089/)
